    ...
    public List<String> executeOneCPUTurn(GameSession gs) {
        ...
        if (type == 1) {
            ...
            if ("reserved".equals(src)) {
                ...
                ok = buyCardFromTable(gs, level, idx);
        ...
        if (p.getTokens().size() > gs.getMaxTokensPerPlayer()) {
            ...
            executeReturnTokens(gs, toReturn);
        }
